...
initial_angle1_deg = float(input("Enter the initial angle for the first pendulum (in degrees): "))
initial_angle2_deg = float(input("Enter the initial angle for the second pendulum (in degrees): "))
total_time = 20 # int(input("Enter the total time for the simulation (in seconds): "))
...
while loop_counter <= 20:
    ...
    plt.close()
    loop_counter += 1
    initial_angle1_deg += 0.2
    initial_angle2_deg += 0.2
    initial_angle1_deg = round(initial_angle1_deg, 1)
    initial_angle2_deg = round(initial_angle2_deg, 1)
    ...
    # Auto-close the figure after the allotted time
    ...
    # Create a timer to close the figure after the animation duration
    duration_ms = t_span[1] * 1000  # Duration in milliseconds
    timer = fig.canvas.new_timer(interval=duration_ms)
    timer.add_callback(close_figure, None)
    timer.start()
